...
import ca.uqac.lif.cep.ProcessorBox.Coordinate.Orientation;
...
public class ProcessorBox 
{
	...
	static
	{
		s_image01 = FileHelper.internalFileToBytes(ProcessorBox.class, "processor-0-1.png");
		s_image10 = FileHelper.internalFileToBytes(ProcessorBox.class, "processor-1-0.png");
		s_image11 = FileHelper.internalFileToBytes(ProcessorBox.class, "processor-1-1.png");
		s_image21 = FileHelper.internalFileToBytes(ProcessorBox.class, "processor-2-1.png");
	}
	 ...
	 */
	public ProcessorBox(Processor p)
	{
		this(p, null);
	}
	 ...
	 */
	public ProcessorBox(Processor p, byte[] image)
	{
		super();
		m_id = s_idCounter++;
		m_processor = p;
	 ...
	 * @return This box
	 */
	public ProcessorBox setImage(byte[] image)
	{
		m_image = image;
		return this;
	}
	 ...
	 * @return This box
	 */
	public ProcessorBox setInputPoints(Coordinate[] coordinates)
	{
	 ...
	 * @return This box
	 */
	public ProcessorBox setOutputPoints(Coordinate[] coordinates)
	{
	 ...
	 * @return This box
	 */
	public ProcessorBox setSize(int width, int height)
	{
		m_width = width;
		m_height = height;
		return this;
	 ...
	 * @return This box
	 */
	public ProcessorBox setSettings(ProcessorSettings settings)
	{
		m_settings = settings;
		return this;
	}
	 ...
	 * @return This box
	 */
	public ProcessorBox setX(float x)
	{
		m_x = x;
		return this;
	}
	 ...
	 * @return This box
	 */
	public ProcessorBox setY(float y)
	{
		m_y = y;
		return this;
	}
	...
	public static class GenericEditorBox extends ProcessorBox
	{
