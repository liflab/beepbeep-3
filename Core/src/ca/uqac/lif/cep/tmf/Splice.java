 ...
 * <p>
 * Currently, the splicer is implemented as a 0:n processor, and the processors
...
public class Splice extends Source
{
  ...
  /**
   * Creates a new Splice processor.
   * @param processors A list of processors to splice
   */
