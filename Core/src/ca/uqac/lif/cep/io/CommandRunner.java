...
public class CommandRunner extends Thread
{
   ...
   *          The command to run
   * @param stdin
   *          If not set to null, this string will be sent to the stdin of the
   *          command being run
   */
  ...
  /**
   * Constantly reads an input stream and captures its content. Inspired from
   * <a href=
   * "http://stackoverflow.com/questions/14165517/processbuilder-forwarding-stdout-and-stderr-of-started-processes-without-blocki">ArrayDeque
   * Overflow</a>
   */
